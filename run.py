...
def banner():
    ...
    {cyan}  .'`---=___`===':{greenLight}   ____) | | | |  __/ | |  {yellow}| {red}Author : X R BIN ARIYAN
    {cyan} /_..---' ___.--.'{greenLight}  |_____/|_| |_|\___|_|_|  {yellow}| {red}Team   : THE BLUE CYBER SQUAD
    ...
    {cyan}      `--'`._.-'  {red}GitHub : https://github.com/DX-NAHID                             
        ''')
...
def main():
    ...
    try:
        ...
        banner()
        print(' How To Use : ')
        print(f'\n{white} python run.py <listweb.txt> \n')
        exit()
    except:
        print(' Unknown Error ! ')
        exit()
